...
public class ProductAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        TextView txtDescrip = (TextView) view.findViewById(R.id.txtDescription);
        ...
        final ConstraintLayout layout = (ConstraintLayout) view.findViewById(R.id.linear01);
        if(positionSelected == i){
            layout.setBackgroundColor(Color.parseColor("#F4DDDD"));
        }
        else
